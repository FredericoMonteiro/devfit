...
const Page = (props) => {
   ...
   const addWorkout = (item) => {
    ...
    return (
        <Container>
        <HeaderText>Opções de treinos pré-criados com base no teu nível</HeaderText>
        <HeaderText><BoldText>Selecionas-te {props.myWorkouts.length} treinos</BoldText></HeaderText>
    ...
    />  
        <HeaderText>Podes alterar a qualquer momento.</HeaderText>
    </Container>
    );
}
