        ...
        <>
            ...
            {dayOff &&
                ...
                {!dayOff && !isFuture && isDone &&
                    <>
                    <BalloonBigText><Strong>Parabéns</Strong>, está pago!</BalloonBigText>
                ...
                {!dayOff && !isFuture && !isDone && !isToday &&
                    <>
                    <BalloonBigText><Strong>Fraco!</Strong> faltaste neste dia.</BalloonBigText>
                ...
                {!dayOff && !isFuture && !isDone && isToday &&
                    <>
                    <BalloonBigText>HOJE HÁ TREINO 🚀</BalloonBigText>
                    <BalloonText>Tens {timeLeft} pra treinar</BalloonText>
